...
public class AdvancementsTrigger extends SimpleProgressibleCriterionTrigger<AdvancementsTrigger.TriggerInstance> {
    ...
    public void trigger(ServerPlayer player, Identifier advancement, int number) {
    ...
    public record TriggerInstance(Optional<ContextAwarePredicate> player, Optional<Identifier> advancement,
        ...
        public static final Codec<TriggerInstance> CODEC = RecordCodecBuilder.create(
                instance -> instance.group(
                        ...
                        Identifier.CODEC.optionalFieldOf("advancement").forGetter(TriggerInstance::advancement),
        ...
        public static Criterion<TriggerInstance> advancement(Identifier advancement) {
            return EnigmaticsBingoGoalsTriggers.ADVANCEMENTS.get().createCriterion(
                    new TriggerInstance(Optional.empty(), Optional.of(advancement), MinMaxBounds.Ints.ANY)
            );
        }

        public boolean matches(Identifier advancement, int number, ProgressListener<TriggerInstance> progressListener) {
