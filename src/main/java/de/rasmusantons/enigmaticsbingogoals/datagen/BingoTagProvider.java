...
public class BingoTagProvider implements DataProvider {
    ...
    private void addTags(Consumer<BingoTag.Holder> tagAdder) {
        ...
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.OVERWORLD_EXPLORE).difficultyMax(1, 1, 1, 1, 1, 1).build());
        ...
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.END_PROGRESS).difficultyMax(1, 1, 1, 1, 1, 1).build());
        ...
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.TRIAL_CHAMBER).difficultyMax(3, 3, 3, 3, 3, 3).build());
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.BREEZE).difficultyMax(1, 1, 1, 1, 1, 1).build());
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.SILVERFISH).difficultyMax(1, 1, 1, 1, 1, 1).build());
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.SWAMP).difficultyMax(1, 1, 1, 1, 1, 1).build());
        tagAdder.accept(BingoTag.builder(EnigmaticsBingoTags.SIGN).difficultyMax(1, 1, 1, 1, 1, 1).build());
    }
}
