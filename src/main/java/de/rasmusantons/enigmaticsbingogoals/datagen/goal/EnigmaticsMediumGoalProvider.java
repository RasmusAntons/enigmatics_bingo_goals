...
public class EnigmaticsMediumGoalProvider extends EnigmaticsDifficultyGoalProvider {
    ...
    public void addGoals() {
        ...
        addGoal(obtainItemGoal(eid("obtain_end_crystal"), items, Items.END_CRYSTAL)
                .tags(BingoTags.NETHER, EnigmaticsBingoTags.EYE_OF_ENDER, EnigmaticsBingoTags.BLAZE_POWDER, EnigmaticsBingoTags.FORTRESS)
        );
        ...
        addGoal(potionGoal(eid("obtain_potion_of_harming"), items, Potions.HARMING, Potions.LONG_STRENGTH, Potions.STRONG_STRENGTH)
                .tags(BingoTags.NETHER, EnigmaticsBingoTags.BLAZE_POWDER, EnigmaticsBingoTags.FORTRESS, EnigmaticsBingoTags.INSTANT_DAMAGE)
        );
        ...
        addGoal(obtainSomeItemsGoal(eid("obtain_some_fire_charges"), items, Items.FIRE_CHARGE, 4, 10)
                .tags(BingoTags.OVERWORLD, BingoTags.NETHER, EnigmaticsBingoTags.FORTRESS, EnigmaticsBingoTags.BARTERING, EnigmaticsBingoTags.TRIAL_CHAMBER)
        );
